...
I am a **Robotics Engineer** currently pursuing a **Master’s Degree in Computing & Intelligent Systems** at the *University of Deusto* (Bilbao, Spain). My profile combines solid engineering principles with hands-on application in **Artificial Intelligence**, **Computer Vision**, **Reinforcement Learning**, and **Industrial Automation**.

- 🛰️ **Systems Engineer @ Satlantis-Deusto**: Designing and developing a CubeSat satellite in a multidisciplinary environment.
- 🎓 **Focus Areas**: Computer Vision, Reinforcement Learning, MLOps, Collaborative Robotics (Cobots), and Data Analytics.
...
- ⚙️ **Practicing MLOps**: Containerizing Deep Learning and RL models with Docker and FastAPI.
